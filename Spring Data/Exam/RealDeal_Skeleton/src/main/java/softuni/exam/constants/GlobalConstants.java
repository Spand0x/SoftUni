...
public class GlobalConstants {
    public static final String CAR_FILE_PATH = "src/main/resources/files/json/cars.json";
    ...
    public static final String SUCCESSFUL_MESSAGE = "Successfully imported %s - %s";
